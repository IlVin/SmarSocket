...
int main() {
    ...
    assert(pb.size() == 3);
    assert(pb.PeekT(0) == 0b11111111);
    assert(pb.PeekT(1) == 0b01111111);
    assert(pb.PeekT(2) == 0b01111111);
    ...
    assert(pb.PeekT(3) == 0b10000000);
    assert(pb.PeekT(4) == 0b00000000);
    assert(pb.PeekT(5) == 0b00000000);

    assert(pb.PutPkt(0b00000010, 0b00000010, 0b0000000000000010) == false);

    assert(pb.GetPkt(idType, idPin, data) == true);
    assert(pb.size() == 3);
    assert(pb.PeekT(0) == 0b10000000);
    assert(pb.PeekT(1) == 0b00000000);
    assert(pb.PeekT(2) == 0b00000000);
    ...
    assert(pb.PutPkt(0b00000111, 0b00001111, 0b0011111111111111) == true);
    assert(pb.size() == 5);
    assert(pb.PeekT(2) == 0b11111111);
    assert(pb.PeekT(3) == 0b01111111);
    assert(pb.PeekT(4) == 0b01111111);
